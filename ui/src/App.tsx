...
import { CampaignHunter } from "./components/CampaignHunter";

const KNOWN_USERS = ["j.okonkwo", "m.okafor", "it.admin"];

function App() {
  const [view, setView] = useState<"investigate" | "campaigns">("investigate");
          ...
          <div className="mt-4 flex gap-2">
            <button
              ...
              className={`rounded px-3 py-1.5 text-sm font-semibold ${
                view === "investigate" ? "bg-sky-600 text-white" : "bg-slate-800 text-slate-300 hover:bg-slate-700"
              }`}
            >
              Investigate
            </button>
            <button
              ...
              className={`rounded px-3 py-1.5 text-sm font-semibold ${
                view === "campaigns" ? "bg-sky-600 text-white" : "bg-slate-800 text-slate-300 hover:bg-slate-700"
              }`}
            >
              Campaign Hunter
            </button>
